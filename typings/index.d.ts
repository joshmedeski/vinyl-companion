...
declare module "disconnect" {
  ...
  interface Database {
    ...
    getArtist(
      artist: number,
      callback: Callback<DiscogsDatabaseTypes.Artist>
    ): Client;
    ...
    getArtistReleases(
      ...
      callback: Callback<DiscogsDatabaseTypes.ArtistReleasesResponse>
    ): Client;
    getArtistReleases(
      artist: number,
      callback: Callback<DiscogsDatabaseTypes.ArtistReleasesResponse>
    ...
    getArtistReleases(
      artist: number,
      params: PaginationOpts
    ): Promise<DiscogsDatabaseTypes.ArtistReleasesResponse>;
    getArtistReleases(
      artist: number
    ): Promise<DiscogsDatabaseTypes.ArtistReleasesResponse>;
    ...
    getRelease(
      release: number,
      callback: Callback<DiscogsDatabaseTypes.Release>
    ): Client;
    ...
    getReleaseRating(
      release: number,
      user: string,
      callback: Callback<DiscogsDatabaseTypes.ReleaseRatingByUser>
    ): Client;
    getReleaseRating(
      release: number,
      user: string
    ): Promise<DiscogsDatabaseTypes.ReleaseRatingByUser>;
    ...
    getMaster(
      master: number,
      callback: Callback<DiscogsDatabaseTypes.Master>
    ): Client;
    ...
    getMasterVersions(
      master: number,
      params: PaginationOpts,
      callback: Callback<DiscogsDatabaseTypes.MasterVersionsResponse>
    ): Client;
    getMasterVersions(
      master: number,
      callback: Callback<DiscogsDatabaseTypes.MasterVersionsResponse>
    ...
    getMasterVersions(
      master: number,
      params: PaginationOpts
    ): Promise<DiscogsDatabaseTypes.MasterVersionsResponse>;
    getMasterVersions(
      master: number
    ): Promise<DiscogsDatabaseTypes.MasterVersionsResponse>;
    ...
    getLabel(
      label: number,
      callback: Callback<DiscogsDatabaseTypes.Label>
    ): Client;
    ...
    getLabelReleases(
      label: number,
      params: PaginationOpts,
      callback: Callback<DiscogsDatabaseTypes.LabelReleasesResponse>
    ): Client;
    getLabelReleases(
      label: number,
      callback: Callback<DiscogsDatabaseTypes.LabelReleasesResponse>
    ...
    getLabelReleases(
      label: number,
      params: PaginationOpts
    ): Promise<DiscogsDatabaseTypes.LabelReleasesResponse>;
    getLabelReleases(
      label: number
    ): Promise<DiscogsDatabaseTypes.LabelReleasesResponse>;
    ...
    search(
      query: string,
      params: DiscogsDatabaseTypes.SearchParams,
      callback: Callback<DiscogsDatabaseTypes.SearchResponse>
    ): Client;
    search(
      query: string,
      callback: Callback<DiscogsDatabaseTypes.SearchResponse>
    ...
    search(
      query: string,
      params: DiscogsDatabaseTypes.SearchParams
    ): Promise<DiscogsDatabaseTypes.SearchResponse>;
    search(
      params: DiscogsDatabaseTypes.SearchParams
    ): Promise<DiscogsDatabaseTypes.SearchResponse>;
  ...
  interface List {
    getItems(
      list: number,
      params: PaginationOpts,
      callback: Callback<ListsTypes.List>
    ): Client;
  ...
  type GetOrdersParams = PaginationOpts &
    SortingOpts<MarketplaceTypes.OrderSortKeys>;
  interface Marketplace {
    ...
    addListing(
      data: MarketplaceTypes.AddListingData,
      callback: Callback<MarketplaceTypes.AddListingResponse>
    ): Client;
    addListing(
      data: MarketplaceTypes.AddListingData
    ): Promise<MarketplaceTypes.AddListingResponse>;

    editListing(
      listing: number,
      data: MarketplaceTypes.EditListingData,
      callback: Callback<EmptyResponse>
    ): Client;
    editListing(
      listing: number,
      data: MarketplaceTypes.EditListingData
    ...
    getOrders(
      ...
      callback: Callback<MarketplaceTypes.GetOrdersResponse>
    ): Client;
    getOrders(callback: Callback<MarketplaceTypes.GetOrdersResponse>): Client;
    getOrders(
      params: GetOrdersParams
    ): Promise<MarketplaceTypes.GetOrdersResponse>;
    ...
    editOrder(
      order: string,
      data: MarketplaceTypes.EditOrderData,
      callback: Callback<MarketplaceTypes.Order>
    ): Client;

    editOrder(
      order: string,
      data: MarketplaceTypes.EditOrderData
    ): Promise<MarketplaceTypes.Order>;

    getOrderMessages(
      order: string,
      params: PaginationOpts,
      callback: Callback<MarketplaceTypes.GetOrderMessages>
    ): Client;
    getOrderMessages(
      order: string,
      callback: Callback<MarketplaceTypes.GetOrderMessages>
    ...
    getOrderMessages(
      order: string,
      params: PaginationOpts
    ): Promise<MarketplaceTypes.GetOrderMessages>;
    getOrderMessages(order: string): Promise<MarketplaceTypes.GetOrderMessages>;

    addOrderMessage(
      order: string,
      data: MarketplaceTypes.AddOrderMessageData,
      callback: Callback<MarketplaceTypes.Message>
    ): Client;
    addOrderMessage(
      order: string,
      data: MarketplaceTypes.AddOrderMessageData
    ): Promise<MarketplaceTypes.Message>;

    getFee(
      price: number,
      currency: string,
      callback: Callback<MarketplaceTypes.Fee>
    ): Client;
    getFee(price: number, currency: string): Promise<MarketplaceTypes.Fee>;

    getPriceSuggestions(
      release: number,
      callback: Callback<MarketplaceTypes.PriceSuggestion>
    ): Client;
    getPriceSuggestions(
      release: number
    ): Promise<MarketplaceTypes.PriceSuggestion>;
  }
  ...
  interface Wantlist {
    getReleases(
      user: string,
      params: PaginationOpts,
      callback: Callback<WantlistTypes.GetWantlistResponse>
    ): Client;
    getReleases(
      user: string,
      callback: Callback<WantlistTypes.GetWantlistResponse>
    ...
    getReleases(
      user: string,
      params: PaginationOpts
    ): Promise<WantlistTypes.GetWantlistResponse>;
    getReleases(user: string): Promise<WantlistTypes.GetWantlistResponse>;

    addRelease(
      user: string,
      release: number,
      data: WantlistTypes.AddReleaseData,
      callback: Callback<WantlistTypes.Want>
    ): Client;
    addRelease(
      user: string,
      release: number,
  ...
  type GetInventoryParams = UserTypes.GetInventoryParams &
    SortingOpts<UserTypes.GetInventorySortingKeys> &
    PaginationOpts;
  type GetContributionsParams = SortingOpts<UserTypes.GetContributionsSortingKeys> &
    PaginationOpts;
  ...
  interface User {
    ...
    getInventory(
      ...
      callback: Callback<UserTypes.GetInventoryResponse>
    ): Client;
    getInventory(
      user: string,
      callback: Callback<UserTypes.GetInventoryResponse>
    ...
    getContributions(
      user: string,
      params: GetContributionsParams
    ): Promise<UserTypes.GetContributionsResponse>;
    getContributions(user: string): Promise<UserTypes.GetContributionsResponse>;

    getSubmissions(
      user: string,
      callback: Callback<UserTypes.GetSubmissionsResponse>
    ): Client;
    ...
    getLists(
      user: string,
      params: PaginationOpts,
      callback: Callback<UserTypes.GetListsResponse>
    ): Client;
    getLists(
      user: string,
      callback: Callback<UserTypes.GetListsResponse>
    ...
    getLists(
      user: string,
      params: PaginationOpts
    ): Promise<UserTypes.GetListsResponse>;
  ...
  interface Collection {
    getFolders(
      user: string,
      callback: Callback<CollectionTypes.UserFolders>
    ): Client;
    ...
    getFolder(
      user: string,
      folder: number,
      callback: Callback<CollectionTypes.UserFolder>
    ): Client;
    getFolder(
      user: string,
      folder: number
    ): Promise<CollectionTypes.UserFolder>;
    ...
    getReleaseInstances(
      user: string,
      release: number,
      callback: Callback<CollectionTypes.ReleasesInstancesResponse>
    ): Client;
    getReleaseInstances(
      user: string,
      release: number
    ...
    getReleases(
      user: string,
      folder: number,
      params: SortingOpts<CollectionTypes.GetReleasesSortingKeys> &
        PaginationOpts,
      callback: Callback<CollectionTypes.ReleasesInstancesResponse>
    ): Client;
    getReleases(
    ...
    addRelease(
      ...
      folder: number,
      release: number,
      callback: Callback<CollectionTypes.AddReleaseResponse>
    ): Client;
    addRelease(
      user: string,
      folder: number,
      release: number
    ): Promise<CollectionTypes.AddReleaseResponse>;
    ...
    editRelease(
      ...
      release: number,
      instance: number,
      data: CollectionTypes.EditReleaseData,
      callback: Callback<EmptyResponse>
    ): Client;
    editRelease(
      user: string,
  ...
  interface OAuthCallback {
    (err: any, auth: OAuthCallbackAuth): void;
  }
